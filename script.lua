...
-- Proteção contra erro: LocalPlayer.Character pode não estar carregado ainda
repeat wait() until LocalPlayer and LocalPlayer.Character and LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
...
ScreenGui.Name = "SochuriTheSemiGodGUI"
...
print("✅ SochuriTheSemiGod Script com Kill Aura e Breath Attack!")
